...
const slides = [
  ...
  },
  {
    ...
    icon: Heart,
    gradient: "from-[#40C4FF]/20 to-[#4DD0E1]/18"
  }
];
  ...
  return (
    <div className="max-w-2xl mx-auto">
          ...
          {slides.map((_, index) => (
            <div
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                index === currentSlide ? 'bg-[#4DD0E1]' : 'bg-white/30'
              }`}
            />
          ))}
        </div>
      ...
      <div className="text-center">
        ...
        <button
          onClick={handleNext}
          className="inline-flex items-center gap-2 px-8 py-4 bg-black/40 hover:bg-black/50 border border-white/15 rounded-xl text-white transition-all duration-300 backdrop-blur-md shadow-[0_4px_16px_rgba(0,0,0,0.25)]"
        >
