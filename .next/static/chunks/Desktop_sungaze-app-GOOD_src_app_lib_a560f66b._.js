...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/meditativeChimes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
;
class MeditativeChimes {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "audioContext", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "masterGain", null);
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/solarLevels.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/supabase/client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/@supabase/ssr/dist/module/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/@supabase/ssr/dist/module/createBrowserClient.js [app-client] (ecmascript)");
;
function createClient() {
    const supabaseUrl = ("TURBOPACK compile-time value", "https://ksoxdzdgzqfhnwwljtqa.supabase.co");
    const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imtzb3hkemRnenFmaG53d2xqdHFhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTkyNjU2NTUsImV4cCI6MjA3NDg0MTY1NX0.uHGoPnpWYpHoy9LrZpmHWIOcn1P4KDV0w9r0c1I5FDc");
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(supabaseUrl, supabaseAnonKey);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/database/subscription-service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SubscriptionService {
    async getUserProfile(userId) {
        ...
        try {
            ...
            throw new Error("Failed to get user profile: ".concat(error instanceof Error ? error.message : 'Unknown error'));
        }
    }
    ...
    async updateUserTier(userId, tier, subscriptionData) {
        try {
            ...
            if (tier === 'founder_444') {
                const { data: user } = await this.supabase.from('profiles').select('badges').eq('id', userId).single();
                if (user) {
            ...
            const { data, error } = await this.supabase.from('profiles').update(updateData).eq('id', userId).select().single();
            if (error) {
    ...
    async purchaseFounderSlot(userId) {
        try {
            ...
            const { error: userError } = await this.supabase.from('profiles').update({
                tier: 'founder_444',
                founderNumber,
    ...
    async hasFounderAccess(userId) {
        ...
        try {
            const { data: user, error } = await this.supabase.from('profiles').select('tier, expirationDate').eq('id', userId).single();
    ...
    async getUserStats(userId) {
        ...
        try {
            const { data: user, error } = await this.supabase.from('profiles').select('tier, badges, seals, founderNumber, expirationDate').eq('id', userId).single();
            if (error || !user) {
                return null;
            }
            let daysRemaining;
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "supabase", (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$src$2f$app$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "founderSlots", {
            sold: 0,
            remaining: 444,
            lastUpdated: new Date().toISOString()
        });
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/elevenlabs.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ElevenLabsService {
    ...
    constructor(config){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "config", void 0);
        this.config = {
...
const initializeElevenLabs = ()=>{
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ELEVENLABS_API_KEY;
    const voiceId = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ELEVENLABS_VOICE_ID;
    if (!apiKey || !voiceId) {
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/speechSynthesis.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class WebSpeechService {
    ...
    constructor(settings){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "settings", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "utterance", null);
        this.settings = {
            rate: 0.7,
            pitch: 0.9,
            volume: 0.8,
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/payments/stripe.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$stripe$2f$stripe$2d$js$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/@stripe/stripe-js/lib/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$stripe$2f$stripe$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/@stripe/stripe-js/dist/index.mjs [app-client] (ecmascript)");
"use client";
;
// Initialize Stripe with environment variable
const stripePromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$stripe$2f$stripe$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadStripe"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY);
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/database/journal-service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class JournalService {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "entries", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "STORAGE_KEY", 'sungaze_journal_entries');
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/solarContent.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/milestones.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/truthSerum.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/oracleQuestions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/questSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/weatherService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class WeatherService {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "weatherCache", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "solarTimesCache", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "userLocation", null);
    }
}
...
"[project]/Desktop/sungaze-app-GOOD/src/app/lib/utils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/clsx/dist/clsx.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$tailwind$2d$merge$2f$dist$2f$bundle$2d$mjs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/sungaze-app-GOOD/node_modules/tailwind-merge/dist/bundle-mjs.mjs [app-client] (ecmascript)");
;
;
function cn() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$tailwind$2d$merge$2f$dist$2f$bundle$2d$mjs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["twMerge"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$sungaze$2d$app$2d$GOOD$2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])(inputs));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
//# sourceMappingURL=Desktop_sungaze-app-GOOD_src_app_lib_a560f66b._.js.map