...
"[project]/SUNGAZE APP/package.json/src/app/lib/consent.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function setConsent(consentGiven) {
    if ("TURBOPACK compile-time truthy", 1) return;
    //TURBOPACK unreachable
    ;
}
function hasValidConsent() {
    if ("TURBOPACK compile-time truthy", 1) return false; // SSR safe
    //TURBOPACK unreachable
    ;
}
...
function isLocationStale(maxAgeHours = 24) {
...
//# sourceMappingURL=SUNGAZE%20APP_package_json_src_app_lib_ecc63ac5._.js.map